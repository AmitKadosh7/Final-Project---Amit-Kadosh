...
Image = imread('C:\Users\user\Desktop\Studies\Semester 8\myProject\de-noise\grayImageDataSet\image11DataSet.png');
if (size(Image,3) == 3)
...
title({'Algorithem 3:',[' psnr = ',num2str(Algorithem3PSNR)],[' ssim = ',num2str(Algorithem3SSIM)]});
