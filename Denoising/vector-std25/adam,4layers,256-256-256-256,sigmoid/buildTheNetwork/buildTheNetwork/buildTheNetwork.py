...
plt.grid()
plt.show()
pdfFile = PdfPages("C:/Users/user/Desktop/Studies/Semester 8/myProject/de-noise/myFilesGray-Vector,adam,4layer,256,sigmoid,0-5million//PlotsResults.pdf")
pdfFile.savefig(fig)
pdfFile.close()
model.save("C:/Users/user/Desktop/Studies/Semester 8/myProject/de-noise/myFilesGray-Vector,adam,4layer,256,sigmoid,0-5million/model.h5")
